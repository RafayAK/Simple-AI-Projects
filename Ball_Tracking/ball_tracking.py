...
args = vars(ap.parse_args()) # converts arguments to a dictionary
...
pts = deque(maxlen=args["buffer"]) # define queue of certain size(buffer)

# if video file is not provided, open up webcam
